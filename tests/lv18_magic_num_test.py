...
def exploit_lv18(contract: MagicNum):
    ...
    deployedForCreationOfContract = Deployer.deploy()
    ...
    # Initialization code:
    initialize_piece1 = "600a" # push1 0x0a
    initialize_piece2 = "600c" # push1 0x0c
    initialize_piece3 = "6000" # push1 0x00
    ...
    addressOfSolver = deployedForCreationOfContract.deploy_(bytes.fromhex(combinedEncodedCode)).return_value
